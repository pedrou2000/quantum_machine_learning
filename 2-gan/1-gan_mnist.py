# Source: https://www.tensorflow.org/tutorials/generative/dcgan?hl=en
...
# Test it without previously training it.
...
### 4. Defining the Loss Functions for Generator and Discriminator. ###
...
# It compares the discriminator's predictions on real images to an array of 1s, and the discriminator's predictions on 
...
# Save checkpoints: This notebook also demonstrates how to save and restore models, which can be helpful 
...
# set) and fakes images (produced by the generator). The loss is calculated for each of these models, 
...
### 7. Creating the GIF as a Final Result. ###
